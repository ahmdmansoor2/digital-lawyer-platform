...
async function generateScript(topic, opts = {}) {
  ...
  const prompt = `أنت خبير قانوني في التشريع المصري، وكاتب محتوى إذاعي محترف باللغة العربية الفصحى. اكتب سكريبت فيديو قصير (60-90 ثانية) عن:
...
قواعد اللغة والإخراج (غير قابلة للتفاوض):
- اللغة: عربية فصحى سليمة 100٪ في كل كلمة وجملة — لا عامية، لا لهجة محلية، لا ألفاظ مبتذلة، لا تعابير شعبية
- الأسلوب: فصيح، واضح، أنيق، بمستوى لغة إعلامية وقانونية رفيعة تناسب محتوى توعوي قانوني
- الجمل: مترابطة وقوية، بلا جمل مبتورة، بلا تكرار، بلا حشو أو كلام زائد
- الدقة القانونية: 100٪ — اذكر المادة القانونية أو المرجع عند اللزوم (مثل "وفقاً للمادة ٣٤٠ من قانون العقوبات") ولا تختصر أي معلومة قانونية
- الترقيم والفواصل: دقيقة وواضحة تساعد قارئ الصوت الآلي على النطق السليم
- البداية: جملة Hook قوية خلال أول ٣ ثوانٍ تسحب المشاهد
- النهاية: CTA واضح يدعو للمتابعة أو الاستشارة
- لا مقدمات ولا خواتيم تقنية مثل "في هذا الفيديو سنتحدث عن"

أرجع JSON فقط بدون أي كلام إضافي:
{
  "hook": "الجملة الأولى الجاذبة (٣ ثوان)",
  "full_text": "النص الكامل للسكريبت",
  "hashtags": ["هاشتاج1", "هاشتاج2", "هاشتاج3", "هاشتاج4", "هاشتاج5"],
  "scenes": [
    {
      "id": 1,
      "duration_sec": 8,
      "narration": "الجملة المنطوقة في هذا المشهد",
