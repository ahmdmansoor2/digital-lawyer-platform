...
const TOPIC_POOL = [
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    body: `
      ...
      <h2><span class="num">3</span> إجراءات ما بعد الحادث مباشرة</h2>
      <ol>
        <li><strong>الإبلاغ الفوري:</strong> الاتصال بالشرطة أو هيئة الإنقاذ (123) وعدم تحريك المركبات قبل وصول الشرطة لرسم مخطط الحادث.</li>
        <li><strong>تحرير محضر المرور:</strong> الحرص على إثبات جميع التفاصيل بمحضر شرطة المرور واسترداد نسخة منه.</li>
        <li><strong>التقرير الطبي الشرعي:</strong> فحص المصابين بمستشفى حكومي للحصول على تقرير طبي شرعي رسمي يوثق الإصابات.</li>
        <li><strong>إخطار شركة التأمين:</strong> إشعار شركة التأمين خلال 48 ساعة وفق الشروط العامة للوثيقة.</li>
        <li><strong>حجز السيارة:</strong> طلب حجز السيارة المتسببة كضمان للتعويض.</li>
      </ol>

      <h2><span class="num">4</span> حساب التعويض من شركة التأمين</h2>
      <p>وفق قانون التأمين الإلزامي وقرارات الهيئة المصرية للرقابة على التأمين:</p>
      <ul>
        <li><strong>حد التعويض عن الوفاة أو العجز الكلي:</strong> لا يقل عن 100,000 جنيه وفق الحد الأدنى المقرر.</li>
        <li><strong>حد التعويض عن العجز الجزئي:</strong> بنسبة العجز من مبلغ التأمين.</li>
        <li><strong>التعويض عن تلف الممتلكات:</strong> في حدود ما تنص عليه الوثيقة.</li>
        <li><strong>التعويض التكميلي:</strong> إذا كان الضرر يفوق حد التأمين يُرجع المضرور على المسؤول شخصياً بالفارق.</li>
      </ul>

      <h2><span class="num">5</span> الدعوى الجنائية ودورها في التعويض</h2>
      <div class="callout">
        <span class="callout-icon">🏛️</span>
        <p><strong>الادعاء المدني أمام المحكمة الجنائية:</strong> يستطيع المضرور الادعاء مدنياً بالتعويض ضمن إجراءات الدعوى الجنائية. ميزة هذا المسار أن الحكم الجنائي بالإدانة يُقيد المحكمة المدنية بشأن ثبوت الخطأ ويُقلل من عبء الإثبات.</p>
      </div>

      <h2><span class="num">6</span> أسئلة قانونية شائعة (FAQ)</h2>
      <div class="faq-grid">
        <div class="faq-item">
          <h4>❓ هل يُعوَّض المصاب إذا كانت السيارة بدون تأمين سارٍ؟</h4>
          <p>نعم، أنشأ القانون صندوقاً لضمان المسؤولية يتولى التعويض عن حوادث السيارات غير المؤمن عليها أو مجهولة السيارة (الهروب من مكان الحادث).</p>
        </div>
        <div class="faq-item">
          <h4>❓ هل يُعوَّض الراكب الذي يعلم أن السائق سكران؟</h4>
          <p>يخفف علم الراكب برداءة حالة السائق من التعويض المستحق له، لأن ركوبه يُعدّ إسهاماً في إحداث الضرر بنفسه.</p>
        </div>
        <div class="faq-item">
          <h4>❓ ما مدة تقادم دعوى التعويض عن حوادث المرور؟</h4>
          <p>ثلاث سنوات من يوم علم المضرور بالضرر وبالمسؤول. وتتوقف هذه المدة بتقديم البلاغ الجنائي أو بدء إجراءات التحقيق.</p>
        </div>
      </div>
