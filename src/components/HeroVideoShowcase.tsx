 ...
 *
 * HeroVideoShowcase — مشغل الفيديو السينمائي الرسمي لمنصة المحامي الرقمية
 * يشغل ملف الفيديو MP4 الحقيقي المدمج مع التعليق الصوتي والمشاهد السينمائية
 */
...
export default function HeroVideoShowcase({ onEnterApp }: { onEnterApp?: () => void }) {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto my-8 relative" id="promo-video-container">
      ...
      <div className="relative rounded-3xl border border-white/20 bg-slate-950/95 backdrop-blur-2xl shadow-2xl overflow-hidden ring-1 ring-white/10">
        ...
        <div className="bg-slate-950/90 border-b border-slate-800 px-4 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1.5 ms-3 text-xs font-bold text-slate-300">
              ...
              <span>فيديو تعريفي: من الفوضى... إلى السيطرة (100 ثانية)</span>
            </div>
          </div>
        ...
        <div className="relative aspect-video w-full bg-black overflow-hidden flex items-center justify-center group">
          ...
          <video
            ...
            poster="/images/promo/scene_digital.jpg"
            preload="metadata"
            playsInline
            ...
            >
              ...
              <div className="text-center px-4">
                <span className="text-sm sm:text-base font-black text-white block drop-shadow-md">
                  مشاهدة الإعلان السينمائي مع التعليق الصوتي 🎙️
                </span>
                <span className="text-xs text-indigo-200 block mt-0.5">
                  انقر للتشغيل والاستماع للقصة الكاملة
                </span>
              </div>
            </div>
          )}

          {/* Bottom Video Controls Overlay (shown on hover or when playing) */}
        ...
        <div className="bg-slate-950 p-3 text-center border-t border-slate-800 text-xs text-slate-400 flex flex-wrap items-center justify-around gap-2">
          <span className="flex items-center gap-1.5 text-slate-300 font-semibold">
            ...
            <span>قصة حقيقية عن رحلة التحول الرقمي للمحامي المصري</span>
          </span>
          <a
            href="/media/promo_video.mp4"
            download="Digital_Lawyer_Promo.mp4"
