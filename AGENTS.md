...
>    - **المعايير التحريرية الملازمة:** لغة عربية منضبطة وسليمة 100%، صياغة المنشور وفق هندسة NotebookLM Pro التأصيلية الرفيعة مع حذف أي عبارات نمطية مثل "📊 مخطط بياني تعليمي"، وتذييل المنشور دائماً بروابط حاسبات المنصة والصفحة الرئيسية.
