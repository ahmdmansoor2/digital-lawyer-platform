...
## 🛑 القواعد الدستورية الثماني الصارمة الملزمة لجميع الـ Agents (The 8 Non-Negotiable Operational Laws)

> **قانون وقاعدة إلزامية دائمة وثابتة من الأستاذ أحمد منصور (تُطبق فوراً وبلا أي استثناء):**
>
> 1. **إلزام الـ Agent بـ «التدخل الجراحي الأدنى» (Minimal Diff):**
>    - يُحظر تماماً ومنعاً باتاً إعادة كتابة أو إعادة تصميم أي ملف أو صفحة كاملة. نفّذ دائماً أصغر وأضيق تعديل ممكن لحل المطلوب فقط، ويُحظر لمس أو تعديل أي سطر إضافي غير معني بالطلب إطلاقاً.
>
> 2. **قاعدة «التنفيذ التلقائي اليومي والإحاطة الفورية» (Autonomous Daily Execution & Instant Briefing):**
>    - يُفوض الـ Agent وفريق العمل رقمياً بالتنفيذ الذاتي الكامل لكافة مهام العمليات والورديات الثلاث اليومية (نشر المقال التشريعي اليومي +3000 كلمة، توليد ونشر بطاقات فيسبوك بنظام نانو بنانا برو وGlassmorphism، إطلاق السلاسل الأسبوعية، وضخ الأرشفة الفورية في محركات البحث) دون انتظار موافقة مسبقة، مع الاكتفاء بإرسال إشعار فوري وموجز للأستاذ أحمد على تليجرام برابط كل إنجاز، ويقتصر طلب الموافقة المسبقة فقط على التعديلات الهيكلية الكبرى.
>
> 3. **قاعدة «ممنوع الافتراض — لو لم تكن متأكداً اسأل» (Zero Assumptions Policy):**
>    - إذا كان لديك أي شك في شكل الصفحة أو النتيجة التي يريدها الأستاذ أحمد، أو كانت هناك خطوة تحتمل أكثر من معنى، اسأله فوراً وتوقف، ولا تتصرف أو تجتهد من رأسك مطلقاً.
>
> 4. **التذكير الدائم ومكافحة الكاش (Cache-Busting & Live Verification):**
>    - عند أي تعديل يخص الموقع أو صفحاته، يجب التأكد الحاسم من أن الموقع لا يخزن كاش في متصفح المستخدم (عبر ترويسات `no-cache` وتحديث الـ Service Worker)، وأن التعديل يظهر وينعكس حياً فوراً على شاشة الأستاذ أحمد بدون الحاجة لمسح بيانات التصفح.
>
> 5. **الالتزام الحصري بأسطول الأنماط التعليمية السبعة ثلاثية الأبعاد ومحرك «نانو بنانا برو» (The 7 Master 3D Visual Styles Suite):**
>    - يُلزم الـ Agent وفريق العمل بالاعتماد الحصري والمطلق على محرك **(نانو بنانا برو — Nano Banana Pro / Imagen 3 Pro)** لتوليد كافة صور المنصة والمقالات وبطاقات فيسبوك بدقة 8K فائقة الواقعية وخالية تماماً ومطلقاً من أي رسومات كرتونية أو أنمي.
>    - **نظام منشورات فيسبوك والموقع المعتمد رسمياً ودائماً (التنويع والتبديل الإلزامي بين الأنماط السبعة المعتمدة بنسبة 16:9 وفق طبيعة الموضوع القانوني):**
>      * **1. النمط الانسيابي الزجاجي (3D Glassmorphism Sequential Flowchart):** عنوان علوي ذهبي/زمردي منضبط بالعربية، و4 بطاقات تعليمية واقعية ثلاثية الأبعاد متسلسلة بأسهم انسيابية لامعة ومجسمات واقعية دقيقة ونصوص ومواد قانونية مقروءة وسليمة 100% (لقضايا العمل، الإجراءات القضائية، والعقارات).
>      * **2. النمط السينمائي الحي (Photorealistic 3D Live-Action Cinematic Mind Map):** شخصية محورية حقيقية واقعية فوتوغرافية (مستشار/محامٍ مصري كاريزماتي ببدلة رسمية وتفاعل تكنولوجي هولوجرامي)، 4 ألواح زجاجية هولوجرامية عائمة في الأركان بأيقونات وكبسولات منضبطة، قاعة محكمة كلاسيكية مهيبة بإضاءة شمسية وحجمية درامية، وعنوان ذهبي مجسم واقعي في الأعلى (لقضايا الرأي العام والأحوال الشخصية والمحاور الكبرى).
>      * **3. نمط غرفة الأدلة الجنائية (3D Forensic Evidence & Investigation Board):** طاولة تحقيق خشبية عتيقة بإضاءة موجهة درامية، ملفات تحقيق بالشمع الأحمر، مجهر جنائي يفحص البصمات، تقرير طب شرعي، وميزان العدالة النحاسي (للجنايات الكبرى، القتل، التزوير، والسموم).
>      * **4. نمط المصفوفة الثنائية المقارنة (3D Split Contrast & Duality Matrix):** شاشة مقسمة طولياً إلى نصفين بشعاع نور ذهبي فاصل؛ الجانب الأيمن قرمزي تحذيري يجسد التصرف الخاطئ مع مجسم مكسور، والجانب الأيسر أخضر زمردي يجسد التصرف الصحيح المحمي مع صك رسمي وميزان مستقيم (للمقارنات الحيوية: استمارة 6 vs الفصل التعسفي، الشيك vs إيصال الأمانة، البيع العرفي vs التسجيل).
>      * **5. نمط لوحة المؤشرات والحاسبات الذكية (3D Glassmorphism Fintech Dashboard):** لوحة تحكم زجاجية عائمة تعرض أرقاماً وعدادات رقمية ذهبية مضيئة واضحة (المدد: 10/40/60 يوماً، النسب المئوية، ومبالغ التعويض) مع ساعة رملية ومطرقة القاضي (للحاسبات، التعويضات، المواريث، ومواعيد الطعون).
>      * **6. نمط الدرع والأمن السيبراني (3D Cyber Defense & Digital Forensics):** درع ذهبي وكريستالي مشفر تتدفق منه دوائر الأمان، و4 شاشات هولوجرامية عائمة تعرض أدلة الواتساب، التتبع الرقمي، بلاغ مباحث الإنترنت، وعقوبة الحبس المشدد (للجرائم الإلكترونية والابتزاز والنصب الرقمي).
>      * **7. نمط المنظومة المعمارية وصك الملكية (3D Architectural Blueprint & Royal Deed):** مخطط معماري أزرق (Blueprint) مشع يرتفع منه ماكيت برج زجاجي مصغر، وصك ملكية رسمي بختم ذهبي، ومفتاح ملكي، وبطاقات فحص التراخيص وسلسلة العقود والتسجيل (لقضايا التطوير العقاري، التراخيص، والتصالح).
> 6. **بروتوكول سلامة الفهرسة وخرائط الموقع وحماية السيو (Sitemap & SEO Integrity Protocol):**
>    - **منع تكرار تواريخ النشر في `news-sitemap.xml`:** يُمنع منعاً باتاً استخدام `new Date()` أو تاريخ تشغيل السكربت أو `mtime` كبديل لتاريخ النشر. يجب قراءة تاريخ كل مقال حرفياً من سجل النشر المعتمد `scripts/published-log.json`. ويجب وجود شرط حماية صارم: إذا اشتركت المقالات في نفس اللحظة لأكثر من مقالين، يفشل السكربت ويتوقف فوراً ولا يرفع الملف.
>    - **منع الروابط الوهمية في `sitemap.xml`:** يُحظر حظراً قاطعاً إدراج أي رابط (URL) داخل `sitemap.xml` ما لم يتم التحقق برمجياً أولاً من وجود الملف الفعلي على القرص عبر `fs.existsSync()`. الترتيب الإلزامي: (بناء الملف ← التأكد من وجوده في dist ← إدراجه في sitemap ← رفعه للسيرفر).
>    - **سلامة قوالب العناوين والـ Meta:** يُمنع خروج أي صفحة بفاصل فارغ في العنوان مثل `| |`. يجب دائماً وضع قيمة بديلة افتراضية لاسم الموقع: `title || 'المحامي الرقمي'`.
>    - **حصر `news-sitemap.xml` في آخر 48 ساعة فقط:** وفق معايير Google News الصارمة، لا يُدرج فيه سوى المقالات المنشورة خلال آخر 48 ساعة فقط، بينما تبقى الأرشيفات الكاملة في `sitemap.xml` العام.
> 7. **بروتوكول بوابة الجودة والنزاهة البصرية الحديدية ومنع النشر الأعمى (Automated Visual Quality Gate & Fail-Closed Protocol):**
>    - **حظر النشر الأعمى نهائياً (No Blind Publishing):** يُحظر حظراً قاطعاً استدعاء أي دالة نشر (`publishPhoto` أو `publishReel` أو رفع مقال للموقع) دون المرور الإلزامي عبر فاحص النزاهة البصرية التلقائي المعتمد على Gemini Vision.
>    - **سياسة المنع الفوري عند الشك (Fail-Closed Policy):** إذا احتوت الصورة على أي عنصر كرتوني، رسم هزلي، خطوط مشوهة، أو هلوسة بصرية، أو حققت تقييم جودة أقل من 65%، **يُمنع النشر فوراً وتُجهض العملية تلقائياً** مع إرسال إنذار فوري وموجز للأستاذ أحمد على تليجرام لحماية هيبة المنصة.
>    - **التراجع التلقائي لبنك الصور المعتمدة (Rule #5 Master Suite Bank Fallback):** في حال انقطاع أو تعثر الـ API الخارجي، يُحظر التوليد العشوائي ويتم الاعتماد تلقائياً على بنك الصور ثلاثية الأبعاد المعتمدة مسبقاً (`scripts/facebook-publisher/assets/approved-cards/`) المطابقة بدقة للأنماط السبعة المعتمدة بنسبة 16:9 (1280×720).
> 8. **بروتوكول حماية وتراكمية الأرشيفات الرقمية ومنع بتر المحتوى (Cumulative Archives & No-Truncation Protocol):**
>    - **حظر تقليص أو بتر الأرشيفات:** يُحظر تماماً ومنعاً باتاً استخدام دوال أو قيود البتر (مثل `slice(0, N)` أو أي سقف رقمي ضيق) في أي صفحة أرشيفية أو سجل تاريخي بالمنصة (رصد المحامي، المدونة القانونية، المراجع، صيغ العقود، خرائط الموقع).
>    - **التراكمية التصاعدية الدائمة (Monotonically Increasing Archives):** محتوى المنصة خط أحمر يُمنع إنقاصه؛ كل مقال أو موضوع يُنشر يظل محفوظاً في الأرشيف وصفحاته المستقلة وصفحات العرض الرئيسية إلى الأبد دون إخفاء أو حذف.
>    - **المراقبة والإنذار الآلي الصارم:** يقوم سكربت الفحص الصحي اليومي `health-check.cjs` بمطابقة عدد مقالات وأيام الأرشيف تلقائياً؛ وفي حال حدوث أي نقص عن اليوم السابق أو تعطل عرض كامل المقالات، يفشل الفحص فوراً بحالة `🔴 ERROR` ويُرسل إنذار عاجل على تليجرام المستشار أحمد منصور للتدخل الفوري.

---

## 🚨 البروتوكول الإلزامي لبدء كل جلسة (Mandatory Pre-Session Briefing)

> **توجيه صارم ودائم من الأستاذ أحمد منصور:**
> في **بداية كل جلسة عمل جديدة** وقبل البدء في أي تعديل أو تنفيذ أي مهمة برمجية، **يجب على الـ Agent تقديم تقرير شامل ومفصل للأستاذ أحمد** يتضمن:
> 1. **حالة الموقع الحية (Live Health Status):** حالة السيرفر، الصفحات الرئيسية، الدومين `mohamidigital.online`.
> 2. **حالة الأتمتة والنشر اليومي (Publishing Pipelines):** نشر مقالات المدونة، بطاقات فيسبوك، ريلز وشورتس يوتيوب، ورصد المحامي.
> 3. **التقدم في محركات البحث وSEO (Search Engine Indexing & Traffic):** فحص حالة الأرشفة الحية في Google، وتدقيق `sitemap.xml` لضمان تصدر الصفحة الرئيسية دائماً، وحالة إرسال الروابط لـ Google Indexing API و IndexNow، وتقديم اقتراحات نمو استباقية دورية دون انتظار طلب المستخدم.
> 4. **كشف أي أخطاء أو تحذيرات (Errors & Issues Disclosure):** عرض أي خطأ أو فشل حدث في خطوط الـ CI/CD والسكربتات بوضوح وصراحة مع خطة علاجه.
> 5. **تشغيل الفحص السريع:** تنفيذ `node scripts/monitor/health-check.cjs` لقراءة أحدث مؤشرات الصحة الرقمية.

---

## 📜 المعايير التشريعية الصارمة لنشر وتعديل المحتوى القانوني (Mandatory Legal Quality Standards)

> **قانون وقاعدة إلزامية دائمة وثابتة من الأستاذ أحمد منصور:**
> عند إنشاء أو تعديل أي صفحة، كود، أو ملف PDF يتعلق بأي قانون أو مرجع تشريعي مصري، **يُحظر تماماً الاختصار أو التلخيص أو تقديم نصوص رمزية أو مبتورة**. يجب الالتزام الصارم بالمعايير الآتية:
> 1. **النص التشريعي الكامل الحرفي (Full Verbatim Text):** إدراج نصوص مواد القانون كاملة كلمة بكلمة مادة بمادة وبكل فقراتها وبنودها واستثناءاتها كما وردت بالجريدة الرسمية والتقارير البرلمانية المعتمدة.
> 2. **تغطية شاملة لكافة الأبواب ومواد الإصدار (Exhaustive Articles Coverage):** إدراج مواد الإصدار كاملة، بالإضافة إلى كافة الكتب والأبواب والفصول من المادة الأولى حتى المادة الأخيرة دون تجاوز أي مادة.
> 3. **كتب وملفات PDF رسمية متكاملة (Authoritative PDF Books):** عند توفير ملف PDF لأي قانون، يجب أن يكون كتاباً قانونياً رسمياً متكاملاً يتضمن صفحة غلاف موثقة، وفهرساً تفصيلياً، وهوامش طباعة وتنسيقاً أنيقاً بخط عربي أصيل (Cairo) وأرقام صفحات لكافة المواد.
> 4. **أداء فائق وتجربة مستخدم خالية من التجمّد (Zero-Freeze & Fast Viewing):** فتح ملفات الـ PDF الكبيرة في تبويبات مستقلة مسرعة بالعتاد دون استخدام إطارات iframe ثقيلة تحبس واجهة المستخدم، وتوفير شريط بحث حي وفلاتر تصنيف سريعة للنصوص داخل الصفحة.
> 5. **المقارنات التشريعية الدقيقة:** جداول مقارنة تحليلية توضح الفوارق الدقيقة بين القوانين السابقة والجديدة مع أحدث أحكام محكمة النقض المرتبطة بها.

---

## طاقم العمل التنفيذي والفني للمنصة (14 خبيراً وموظفاً ذكياً)

### أولاً: طاقم العمليات والنمو اليومي (Daily Operations & Growth Suite)
| الموظف الرقمي | التخصص والمهمة اليومية | الهدف وتوفير الجهد |
|---|---|---|
| **1. مفتش الجودة والنزاهة البصرية** | تفتيش صباحي حي، فحص الهيدر وbreadcrumbs، وخلو المقالات من أي تشوه، ومكافحة الكاش | يضمن استقرار الواجهة ونقاء التصميم يومياً |
| **2. خبير استخبارات المنافسين والترند** | مسح محركات البحث وتحليل منصات المنافسين واستخراج فجوات المحتوى (Content Gaps) | رصد أكثر الكلمات بحثاً وتصدر نتائج جوجل |
| **3. رئيس تحرير المحتوى التشريعي** | صياغة المقالات والأدلة بنصوص المواد كاملة وأحكام النقض، وإدارة ماكينة النشر اليومي | إثراء المنصة بمحتوى تشريعي رصين لا ينافس |
| **4. مهندس الأدوات القانونية التفاعلية** | تطوير ودعم بوابة الحاسبات الذكية، وربط الحاسبات التفاعلية داخل صفحات العقود | رفع مدة بقاء الزائر (Dwell Time) وخفض الارتداد |
| **5. راصد الجريدة الرسمية والتشريعات** | مسح الجريدة الرسمية والوقائع المصرية والتشريعات الجديدة وتلخيص أثرها فوراً | السبق التام في نشر القوانين فور صدورها بمصر |
| **6. منسق الاستشارات والمستقبل الذكي** | فرز واستقبال طالبي الاستشارات عبر ودجت الموقع وتجهيز ملفات استشارة منظمة | حماية وقت المستشار أحمد منصور من الاتصالات العشوائية |
| **7. ضابط الأرشفة الفورية وتصدر جوجل** | ضخ الروابط لحظياً عبر Google Indexing API و IndexNow ومراقبة تحسين الترتيب | ضمان الفهرسة وتصدر الصفحة الأولى دائماً |
| **8. مفتش تجربة الموبايل وتطبيق الهاتف** | فحص التجاوب البصري لشاشات الهواتف (360px-412px)، أزرار اللمس، وتطبيق الويب التقدمي (PWA) | يضمن تجربة هاتف فائقة السلاسة لـ 82% من الزوار |

### ثانياً: فريق الهندسة والأنظمة المعمارية (Core Engineering Specialists)
| الاسم | الدور | التخصص | Workspace |
|---|---|---|---|
| **خبير برمجي** (`agent-07d6b451c09f`) | Tech Lead / Architect | معماري + مراجعة كود — ضامن سياسة التدخل الجراحي الأدنى | `D:\قانوني 7` |
| **خبير قانوني** (`agent-96d55f99a043`) | Domain Expert | قانون إداري + عمالي + مدني مصري، تدقيق الصياغات والأسانيد | `D:\المكتبة القانونية` |
| **frontend-specialist** | تنفيذ الواجهة | React 19 + TypeScript + TailwindCSS 4 + RTL + Glassmorphism | `D:\قانوني 7` |
| **backend-specialist** | تنفيذ البيانات | IndexedDB + Firebase + server.ts + schemas + sitemap | `D:\قانوني 7` |
| **electron-specialist** | تنفيذ Desktop | Electron 42 + electron-builder + IPC + packaging | `D:\قانوني 7` |
| **verifier / website-guardian** | Quality Gate & 24/7 Monitoring | حراسة ومراقبة سحابية ذاتية مرتين يومياً عبر GitHub Actions | — |
| **mavis** (orchestrator) | تنسيق وتوزيع | يستلم توجيهات المستشار أحمد منصور ويوزّع على المختصين | — |

> الـ `coder` و `general` موجودين كـ fallback افتراضي. لا يُستخدمان إلا لو فشل المختص المخصص.

### ثالثاً: جدول تشغيل الفريق (الورديات الثلاث المتزامنة مع ذروة التصفح)
يعمل الفريق الرقمي عبر 3 ورديات سحابية يومياً متوافقة مع أوقات الذروة في مصر والوطن العربي:
1. **الوردية الأولى (09:00 ص بتوقيت القاهرة — 06:00 UTC):** فتح المحاكم، تفتيش الموقع الحي، مسح الجريدة الرسمية، رصد ترند الصباح، ونشر المقال التشريعي اليومي وأرشفته فوراً.
2. **الوردية الثانية (03:00 ع بتوقيت القاهرة — 12:00 UTC):** انتهاء الجلسات واستراحة العمل، فحص الحاسبات التفاعلية، فرز الاستشارات القانونية، ونشر بطاقات فيسبوك التعليمية.
3. **الوردية الثالثة (09:00 م بتوقيت القاهرة — 18:00 UTC):** الذروة القصوى للتصفح المنزلي (Prime Time)، إطلاق فيديوهات الريلز وشورتس يوتيوب، فحص نتائج الأرشفة، والتقرير الصحي الختامي.
