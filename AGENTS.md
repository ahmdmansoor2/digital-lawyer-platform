...
>    - يُلزم الـ Agent وفريق العمل بالاعتماد الحصري والمطلق على محرك **(نانو بنانا برو — Nano Banana Pro / Imagen 3 Pro)** لتوليد كافة صور المنصة والمقالات وبطاقات فيسبوك بدقة 8K فائقة الواقعية.
>    - **نظام منشورات فيسبوك المعتمد رسمياً ودائماً:** تُنشر منشورات فيسبوك حصرياً بنظام **«المخططات البيانية التعليمية ثلاثية الأبعاد (3D Legal Flowchart / Infographic)»** بنسبة 16:9:
>      * عنوان علوي ذهبي بارز ومضبوط باللغة العربية.
>      * 4 بطاقات تعليمية واقعية ثلاثية الأبعاد (غير كرتونية نهائياً) متسلسلة بأسهم انسيابية أو مصفوفات مبتكرة.
>      * تنوع وابتكار دائم في الستايلات التعليمية (مخطط انسيابي متسلسل، شبكة مقارنة ثنائية، خريطة مفاهيم دائرية، لوحة مؤشرات زجاجية، هرم توثيقي إجرائي).
>      * نصوص ومواد قانونية مصرية حقيقية وصحيحة 100% داخل كل بطاقة (عنوان النقطة + إجراء عملي صريح).
>      * مجسمات قضائية وثلاثية أبعاد فاخرة تعبر عن كل خطوة (عقود، أختام رسمية، موازين عدالة، محررات).
