...
>
> 2. **قاعدة «اعرض التعديل قبل الحفظ والنشر» (Preview Before Commit & Deploy):**
>    - قبل أن تعدل أي كود أو تبني أو ترفع للسيرفر، اعرض للأستاذ أحمد في سطرين ما هو السطر المحدد أو الملف الذي ستحذفه أو تضيفه بالضبط، وانتظر موافقته الصريحة قبل التنفيذ.
>
